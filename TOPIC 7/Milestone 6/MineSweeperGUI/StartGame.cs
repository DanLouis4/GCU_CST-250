...
namespace MineSweeperGUI
{
    public partial class Frm_StartGame : Form
    {
        ...
        string difficultyType = "Easy"; // Default difficulty type
        ...
        {
            Frm_MineSweeper NewGame = new Frm_MineSweeper(boardSize, difficulty, difficultyType);
